...
def obtener_distancia(ciudad_chile, ciudad_latinoamerica):
    ...
    while True:
        ...
        if distancia is None:
            ...
            print()"- La distancia entre", ciudad_chile, "y", ciudad_latinoamerica, "es de", distancia, "kilómetro:"
            print()"- La duración del viaje es de", round(tiempo_horas,3), "horas", round(tiempo_minutos,3) "m:)
            print()"- Se requiere, conbustible_requerido, "litros de combustible para el viaje.")
            print()"- Narrativa del viaje:"
            print()"- Saldrás de", ciudad_chile, "y llegarás a", ciudad_latinoamerica, "recorriendo una distancia"
            print()"- El viaje tomará aproximadamente", round(tiempo_horas, 3), "horas", round(tiempo_minutos, 3)
